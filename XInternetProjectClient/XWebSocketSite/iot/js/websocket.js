...
function Fun_createWebsocket() {
	...
	_websocket = new WebSocket("wss://wapp.hddvs.com:6602/");
...
function onMessage(evt) {
	...
	if ("adddevice" == cmd) {
		Fun_IOT_AddDeviceCallback(evt.data);
	}
		if ("modifydevice" == cmd) {
		Fun_IOT_ModifyDeviceCallback(evt.data);
	}
	if ("removedevice" == cmd) {
		Fun_IOT_DeleteDeviceCallback(evt.data);
	}	
