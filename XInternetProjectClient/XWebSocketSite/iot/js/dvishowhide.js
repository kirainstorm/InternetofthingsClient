...
function Fun_showAddDeviceModal() {
	$('#myModalAddDevice').modal({backdrop:'static',keyboard:false}); 
}

function Fun_showModifyDeviceModal(_uuid,_name) {
	$('#modify_device_id').val(_uuid);
	$('#modify_device_name').val(_name);
	
	$('#myModalModifyDevice').modal({backdrop:'static',keyboard:false}); 
}
