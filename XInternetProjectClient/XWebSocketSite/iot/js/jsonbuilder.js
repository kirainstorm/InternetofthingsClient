...
//adddevice
function Fun_createJsonAddDevice(_id,_name) {
    return '{"header":{"command":"adddevice","result":0,"deviceuuid":"'+_id+'","msguuid":""},"info":{"describe":"' + _name + '"}}';
}
//modifydevice
function Fun_createJsonModifyDevice(_id,_name) {
    return '{"header":{"command":"modifydevice","result":0,"deviceuuid":"'+_id+'","msguuid":""},"info":{"describe":"' + _name + '"}}';
}
//removedevice
function Fun_createJsonDeleteDevice(_id) {
    return '{"header":{"command":"removedevice","result":0,"deviceuuid":"'+_id+'","msguuid":""}}';
}
//
