...
PREFIX=c:/armlib/openssl/arm64-v8a
ARCH=android64-aarch64
TOOLCHAIN_ROOT=$TOOLS_ROOT/toolchains/aarch64-linux-android-4.9/prebuilt/windows-x86_64 #${TOOLS_ROOT}/${OUT}-android-toolchain
